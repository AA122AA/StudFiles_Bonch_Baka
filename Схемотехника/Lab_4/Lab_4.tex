...
\begin{document}
    ...
    \begin{singlespace}
        \begin{itemize}
            \item Входное сопротивление каскада с ОБ с учетом сопротивления $R_{\text{э}}$ примерно на 3 порядка больше,
   ...
   \begin{center}
    ...
    \begin{singlespace}
        \begin{itemize}
            ...
            \item Измеренный спад вершины импульса не совпадает с рассчитанным спадом вершины импульса при $t_\text{и}=1.25\text{мс}$;
        \end{itemize}
    \end{singlespace}
